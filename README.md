...
<a href="https://zubakamaraka.github.io/budget/"><img src="https://img.shields.io/badge/▶%20Открыть%20приложение-1F5F46?style=for-the-badge&logoColor=white" alt="Открыть приложение" height="46"></a>
...
1. Открыть **[ссылку на приложение](https://zubakamaraka.github.io/budget/)** в Chrome.
...
(поэтому адрес репозитория менять не стоит).
